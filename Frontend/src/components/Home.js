      ...
      return (
          <div className="App">
            <header className="App-header">
              ...
              <h6 className="one-step-away-text"> You are just one step away from conversating with the bot!! </h6>
              <div>
                ...
                <form onSubmit={(e) => submitForm(e)}>
                    <Row className="mb-3 form-row">
                      <Col className="form-column">
                        <MyTextField label="First Name" 
                                    ...
                                    helperText={formErrors.firstName.error && formErrors.firstName.errorMessage}
                                    required/>
                      </Col>
                      <Col className="form-column">
                        <MyTextField label="Middle Name" 
                                    value={data.middleName || ''} 
                                    className="form-text-field" 
                                    onChange={(e) => updateField(e)}
                                    id="middleName"
                                    error={formErrors.middleName.error}
                                    helperText={formErrors.middleName.error && formErrors.middleName.errorMessage}
                                    />
                      </Col>
                      <Col className="form-column">
                        <MyTextField label="Last Name" 
                                    ...
                                    helperText={formErrors.lastName.error && formErrors.lastName.errorMessage}
                                    required/>
                      </Col>
                    </Row>
                    ...
                    <Row className="mb-3 form-row">
                      <Col className="form-column">
                        <MyTextField label="Email Address" 
                                    ...
                                    helperText={formErrors.email.error && formErrors.email.errorMessage}
                                    required/>
                      </Col>
                      <Col className="form-column">
                        <MyTextField label="Phone Number" 
                                    ...
                                    helperText={formErrors.phone.error && formErrors.phone.errorMessage}
                                    />
                      </Col>
                      <Col className="form-column">
                        <MyTextField type="date" 
                                    ...
                                    value={data.dob || ''} 
                                    onChange={(e) => updateField(e)}
                                    className="form-text-field" id="dob" 
                                    error={formErrors.dob.error}
                                    helperText={formErrors.dob.error && formErrors.dob.errorMessage}
                                    required/>
                      </Col>
                    </Row>
                    ...
                    <Row className="mb-3 form-row">
                      <Col className="form-column">
                        <MyTextField label="Gender" 
                                    ...
                                    helperText={formErrors.gender.error && formErrors.gender.errorMessage}
                      ...
                      <Col className="form-column">
                        <MyTextField label="City" 
                                    ...
                                    helperText={formErrors.city.error && formErrors.city.errorMessage}
                                    required/>
                      </Col>
                      <Col className="form-column">
                        <Button variant="contained" component="label" className="upload-file-btn" fullWidth>
                          <FontAwesomeIcon icon={faUpload} /> &nbsp; &nbsp; Upload Documents
                          <input type="file" 
                                onChange={(e) => updateDocuments(e)}
                                id="documents" multiple hidden/>
                        </Button>
                      </Col>
                    </Row>
                    <Row>
                    ...
                    <div className="submit-btn-div">
                      <Button type="submit" variant='contained' color="success" onClick={submitForm}>
